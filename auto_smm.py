...
Здесь вы найдете важные ссылки для работы с плагином и сервисами SMM.
    ...
    kb_.row(
        InlineKeyboardButton("👨‍💻 Разработчик", url="https://t.me/imildar"),
        InlineKeyboardButton("💬 Поддержка", url="https://t.me/imildar")
    )
    ...
    kb_.row(
        InlineKeyboardButton("📣 Канал", url="https://t.me/PLUGINFPC"),
    )
...
def init_commands(c_: Cardinal):
    ...
    drift_mode = bytes([
        0xD0, 0xA1, 0xD0, 0xBF, 0xD0, 0xB0, 0xD1, 0x81, 0xD0, 0xB8, 0xD0, 0xB1, 0xD0, 0xBE, 0x20, 0xD0, 
        0xB7, 0xD0, 0xB0, 0x20, 0xD0, 0xBF, 0xD0, 0xBE, 0xD0, 0xBA, 0xD1, 0x83, 0xD0, 0xBF, 0xD0, 0xBA, 
        0xD1, 0x83, 0x20, 0xD0, 0xBF, 0xD0, 0xBB, 0xD0, 0xB0, 0xD0, 0xB3, 0xD0, 0xB8, 0xD0, 0xBD, 0xD0, 
        0xB0, 0x20, 0xD1, 0x83, 0x20, 0x40, 0x69, 0x6D, 0x69, 0x6C, 0x64, 0x61, 0x72
    ])
...
def auto_start_plugin(c: Cardinal):
    ...
    """
    logger.info("Проверка автозапуска плагина")
